...
var cards = [
  {
    ...
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Bryan Smith"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Joel Rung</td></tr>
					<tr><td>Profession</td><td>Front End Developer</td></tr>
					<tr><td>Address</td><td>Gardner, MA US</td></tr>
				</tbody>
			</table>
		</div>`,
  },
  ...
  },
  {
    ...
    html: `<div class="profile-image"><img src="${imagePath}/friend.png" width="100%" alt="Tom"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Joan Parker</td></tr>
...

  {
    ...
    html: `<table>
			<tbody>
				<tr><td width="50%">HTML</td></tr>
				<tr><td width="50%">CSS</td></tr>
        <tr><td>JavaScript</td></tr>
				<tr><td>TypeScript</td></tr>
				<tr><td>Python</td></tr>
				<tr><td>C/C++</td></tr>
				<tr><td>SQL/NoSQL</td></tr>
			</tbody>
		</table>`,
  },
  {
...
if (window.location.pathname !== "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Joel" -lastName "Rung"',
        typing: true,
      },
      {
        text: "loading...",
